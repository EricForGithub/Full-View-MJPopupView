...
//    popupView.layer.shadowOpacity = 0.5;
    ...
    NSLayoutConstraint *con1 = [NSLayoutConstraint constraintWithItem:popupView attribute:NSLayoutAttributeTop relatedBy:NSLayoutRelationEqual toItem:sourceView attribute:NSLayoutAttributeTop multiplier:1.0 constant:0];
    NSLayoutConstraint *con2 = [NSLayoutConstraint constraintWithItem:popupView attribute:NSLayoutAttributeBottom relatedBy:NSLayoutRelationEqual toItem:sourceView attribute:NSLayoutAttributeBottom multiplier:1.0 constant:0];
    NSLayoutConstraint *con3 = [NSLayoutConstraint constraintWithItem:popupView attribute:NSLayoutAttributeLeft relatedBy:NSLayoutRelationEqual toItem:sourceView attribute:NSLayoutAttributeLeft multiplier:1.0 constant:0];
    NSLayoutConstraint *con4 = [NSLayoutConstraint constraintWithItem:popupView attribute:NSLayoutAttributeRight relatedBy:NSLayoutRelationEqual toItem:sourceView attribute:NSLayoutAttributeRight multiplier:1.0 constant:0];
    
    [sourceView addConstraints:@[con1,con2,con3,con4]];
